<template>
    <Head title="Create car &sdot; Leba Admin Panel &sdot;" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <label>Name</label>
                                <input class="form-control" type="text" value="Jeep Wrangler" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            <div class="mt-3 col-12 col-sm-6 mt-sm-0">
                                <label>Model</label>
                                <input class="form-control" type="text" value="Sahara" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-3">
                                ...
                                <input class="form-control" type="text" value="$990" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            <div class="col-3">
            ...
            <div class="col-lg-7">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <input class="form-control mt-4" type="file">
                            </div>
                        </div>
                    </div>
                </div>
